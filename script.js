...
function searchWeather(searchValue) {
    fetch("http://api.openweathermap.org/data/2.5/weather?q=" + searchValue + "&appid=c32fe1891889v83f4ae7a7f7acc354dc&units=imperial")
...
function getForecast(searchValue) {
    fetch("http://api.openweathermap.org/data/2.5/forecast?q=" + searchValue + "&appid=c32fe1891889v83f4ae7a7f7acc354dc&units=imperial")
        .then(function (response) {
...
function getUVIndex(lat, lon) {
    fetch("http://api.openweathermap.org/data/2.5/uvi?appid=c32fe1891889v83f4ae7a7f7acc354dc&lat=" + lat + "&lon=" + lon)
        .then(function (response) {
            return response.json();
        }).then(function (data) {
